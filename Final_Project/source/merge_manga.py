...
# Danh sách các file CSV cần ghép - Có thể thay đổi để phù hợp với cách tổ chức file trong folder
file_paths = ['raw_data/raw_manga_1.csv', 'raw_data/raw_manga_2.csv', 'raw_data/raw_manga_3.csv', 'raw_data/raw_manga_4.csv']

# Tên file kết quả - Có thể thay đổi để phù hợp cách tổ chức file trong folder
